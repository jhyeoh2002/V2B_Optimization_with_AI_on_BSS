...
def schedule_batteries(fully_charged_series, n_station, tnum, SOC_thr=0.9, max_stay_duration=24):
    ...
    # SOC_d_v = len(t_d_v) * [SOC_thr]  # All batteries need to be charged to SOC_thr at departure
