...
class DataReader:
    ...
    def get_building_energy_demand():
        ...
        """
        df = DataReader.read_and_process("./data/timeseries/building_data.csv")
    ...
    def get_electricity_price():
        ...
        """
        g2b_df = DataReader.read_and_process("./data/timeseries/electricitycostG2B_data.csv")
        g2v_df = DataReader.read_and_process("./data/timeseries/electricitycostG2V_data.csv")
    ...
    def get_photovoltaic_generation():
        ...
        """
        radiation_df = DataReader.read_and_process("./data/timeseries/radiation_data.csv")
        temperature_df = DataReader.read_and_process("./data/timeseries/temperature_data.csv")
